...
>>>>>>> fc85160b13687ae2dcedffba2e8cfd434751f6dd
        ...
        private void metroButton7_Click_1(object sender, EventArgs e)
        {
            ...
            if (ord.meet7count >= 2)
            {
                for (int i = 0; i < count; i++)
                {
                    if (listView1.Items[i].SubItems[0].Text == metroButton7.Text) // 리스트 뷰에 해당 버튼의 텍스트가 있으면
                    {
                        listView1.Items[i].Focused = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView1.Items[i].Selected = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView1.FocusedItem.SubItems[0].Text = metroButton7.Text; // 포커스된 부분에 내용 덮어쓰는거
                        listView1.FocusedItem.SubItems[1].Text = Convert.ToString(ord.meet7count); // 포커스된 부분에 내용 덮어쓰는거
                        listView1.FocusedItem.SubItems[2].Text = Convert.ToString(ord.Meet7Sum()); // 포커스된 부분에 내용 덮어쓰는거
                        ord.meet7count++;
                        listView1.Items[i].Selected = false;
                    }
                }
            ...
            {
                var meat = new string[] { this.metroButton7.Text, Convert.ToString(ord.meet7count), Convert.ToString(ord.Meet2Sum()) };
                var lvt = new ListViewItem(meat);
                this.listView1.Items.Add(lvt);
                listView1.Focus();
                ord.meet7count++;
        ...
        private void metroButton8_Click_1(object sender, EventArgs e)
        {
            ...
            if (ord.meet8count >= 2)
            {
                for (int i = 0; i < count; i++)
                {
                    if (listView1.Items[i].SubItems[0].Text == metroButton8.Text) // 리스트 뷰에 해당 버튼의 텍스트가 있으면
                    {
                        listView1.Items[i].Focused = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView1.Items[i].Selected = true; // 리스트뷰 컨트롤에서 항목 선택 가능하도록 하는거
                        listView1.FocusedItem.SubItems[0].Text = metroButton8.Text; // 포커스된 부분에 내용 덮어쓰는거
                        listView1.FocusedItem.SubItems[1].Text = Convert.ToString(ord.meet8count); // 포커스된 부분에 내용 덮어쓰는거
                        listView1.FocusedItem.SubItems[2].Text = Convert.ToString(ord.Meet8Sum()); // 포커스된 부분에 내용 덮어쓰는거
                        ord.meet8count++;
                        listView1.Items[i].Selected = false;
                    }
                }
            ...
            {
                var meat = new string[] { this.metroButton8.Text, Convert.ToString(ord.meet2count), Convert.ToString(ord.Meet8Sum()) };
                var lvt = new ListViewItem(meat);
                this.listView1.Items.Add(lvt);
                listView1.Focus();
                ord.meet8count++;
